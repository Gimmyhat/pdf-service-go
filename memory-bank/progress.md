...
- **API для анализа**: 4 endpoint'а для получения и анализа детальных запросов
...
- **Автоматическое создание схемы**: БД инициализируется с полной схемой при развертывании
