...
$configMapTemplate = Get-Content -Raw k8s/nas-pdf-service-templates-configmap.yaml
$configMap = $configMapTemplate -replace '{{ \.base64Content }}', $base64Content
$configMap | Out-File -Encoding utf8 k8s/nas-pdf-service-templates-configmap-filled.yaml 